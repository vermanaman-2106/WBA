        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-amber-200 hover:shadow-lg transition-all duration-500 hover-lift animate-fade-in-left delay-200">
              ...
              <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-amber-200 hover:shadow-lg transition-all duration-500 hover-lift animate-fade-in-left delay-300">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-amber-200 hover:shadow-lg transition-all duration-500 hover-lift animate-fade-in-left delay-400">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
